<%-- 
    ...
    Created on : Jan 26, 2018, 12:15:14 AM
    Author     : jimmy
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/registrarMarcaProducto.js"></script>
        <link type="text/css" rel="stylesheet" href="css/css.css" />
        <title>Registrar Marca Producto</title>
    </head>
    <%
        String Codigo_MP = ObtenerCodigoProducto.CodigoMarcaProducto();
    %>
    <body onload="cargar()">
        <form name="frm" action="ServletMarcaProducto" method="post" id="frmRegistrarMP">
