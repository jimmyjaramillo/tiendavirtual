<%-- 
    Document   : modificarMarcaProducto
    Created on : Jan 25, 2018, 3:57:37 AM
    Author     : jimmy
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/modificarMarcaProducto.js"></script>
    ...
    %>
    <body onload="cargar()">
        <form action="ServletMarcaProducto" method="post" name="frm" id="frmModificarMP">
            <table id="tablaModificarMP">
                <tr>
                    <th colspan="2">
                        <h1> Modificar Marca Producto </h1>
                    </th>
                </tr>
                <tr>
                    <td colspan="2">
